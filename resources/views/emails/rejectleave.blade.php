    ...
    <div class="container-fluid" id="container1">
       ...
       <div class="row">
            <div class="col" id="columnbody">
                <h1 id="headingtitle" style="font-family: 'Montserrat';">Leave Application Status</h1>
                <p id="p1">This is to inform you about the disapproval of your {{$getleavetypename}} request, under this are the details of that leave:</p>
                <p id="p2"><strong>Date of Disapproval:&nbsp;</strong>{{$getdatenow}}<br><strong>Date of Application:</strong>&nbsp;{{$getdatefrom}} - {{$getdateto}}<br><strong>Purpose:</strong>&nbsp;{{$getpurpose}}</p>
                <p id="p3">It is because you have to finish your remaining tasks and to avoid conflict with the deadline. We hope you understand the situation and if you have any questions kindly go to your senior or to the management for clarification.</p>
                <p id="p4">Best Regards,<br>Management</p>
            </div>
        </div>
           <div class="row">
