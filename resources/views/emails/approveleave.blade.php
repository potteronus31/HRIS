    ...
    <div class="container-fluid" id="container1">
       ...
       <div class="row">
            <div class="col" id="columnbody">
                ...
                <p id="p1">This is to inform you about the approval of your {{$getleavetypename}} from {{$getdatefrom}} to {{$getdateto}}. Under this are the details of your approved leave:</p>
                <p
                    id="p2"><strong>Date of Approval: </strong>{{$getdatenow}}<br><strong>Date of Application:</strong> {{$getdatefrom}} - {{$getdateto}}<br><strong>Purpose:</strong> {{$getpurpose}}</p>
                    <p id="p3">If you have any questions kindly go to your senior or to the management for clarification.&nbsp;</p>
