    ...
    <div class="container-fluid" id="container1">
        ...
        <div class="row">
            <div class="col" id="columnbody">
                ...
                <p id="p1">Dear HR,<br><br>orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                    <br>
                    Applicant Name: {{$getappname}}
                    Position: {{$getjobname}}
                </p>
                <p id="p3">If you have any questions, kindly go to the management for clarification</p>
                <p id="p4">Best Regards,<br>Management</p></div>
        </div>
        <div class="row">
