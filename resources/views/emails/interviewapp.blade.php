    ...
    <div class="container-fluid" id="container1">
       ...
       <div class="row">
            <div class="col" id="columnbody">
                <h1 id="headingtitle" style="font-family: 'Montserrat';">Lorem Ipsum</h1>

                Position: {{$getjobtitle}}<br>Applicant Name: {{$getname}}<br>Date of Interview: {{date(" F d Y ", strtotime($getdate))}}<br>Time of interview: {{date("g:i A", strtotime($gettime))}}
            </div>
        </div>
           <div class="row">
